...
export const PATCH = async (request, { params }) => {
  try {
    ...
    return new NextResponse(
      "Error occurred in /api/about/section5_slider2/[id] PATCH request",
      { status: 500 }
    );
  }
};
...
export const POST = async (request, { params }) => {
  try {
    ...
    if (existingData !== null) {
      // add data here
      existingData.section5_slider2.push({
        heading: heading,
        quantity: quantity,
      });
    ...
    return new NextResponse(
      "Error occurred in /api/about/section5_slider2/[id] POST request",
      { status: 500 }
    );
  }
};
...
export const DELETE = async (request, { params }) => {
  try {
    ...
    return new NextResponse(
      "Error occurred in /api/about/section5_slider2/[id] DELETE api"
    );
  }
};
